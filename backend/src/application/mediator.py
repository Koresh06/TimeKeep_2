...
from src.application.use_cases.base import UseCase, UseCaseInput


Req = TypeVar("Req", bound=UseCaseInput)
Res = TypeVar("Res")


class Mediator:
    def __init__(self) -> None:
        self._handlers: Dict[Type[UseCaseInput], UseCase[Any, Any]] = {}
