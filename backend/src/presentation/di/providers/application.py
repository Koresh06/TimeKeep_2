...
from src.application.use_cases.day_off.get_all import (
    GetAllDayOffsUseCase,
    GetAllDayOffsQuery,
)
from src.application.use_cases.day_off.get_by_id import (
    GetByIdDayOffQuery,
    GetByIdDayOffUseCase,
)
from src.application.use_cases.day_off.moderate import (
    ModerateDayOffCommand,
    ModerateDayOffUseCase,
)
from src.application.use_cases.day_off.take import TakeDayOffCommand, TakeDayOffUseCase
from src.application.use_cases.department.create import (
    CreateDepartmentCommand,
    CreateDepartmentUseCase,
)
from src.application.use_cases.department.get_all import (
    GetAllDepartmentQuery,
    GetAllDepartmentUseCase,
)
from src.application.use_cases.department.get_by_id import (
    GetDepartmentQuery,
    GetDepartmentUseCase,
)
from src.application.use_cases.document.generate_report import (
    GenerateReportCommand,
    GenerateReportUseCase,
)
from src.application.use_cases.organization.create import (
    CreateOrganizationCommand,
    CreateOrganizationUseCase,
)
from src.application.use_cases.organization.get_all import (
    GetAllOrganizationQuery,
    GetAllOrganizationUseCase,
)
from src.application.use_cases.organization.get_by_id import (
    GetOrganizationQuery,
    GetOrganizationUseCase,
)
from src.application.use_cases.overtime.create import (
    CreateOvertimeCommand,
    CreateOvertimeUseCase,
)
from src.application.use_cases.overtime.delete import (
    DeleteOvertimeRequest,
    DeleteOvertimeUseCase,
)
from src.application.use_cases.overtime.get_all import (
    GetAllOvertimesQuery,
    GetAllOvertimesUseCase,
)
from src.application.use_cases.overtime.get_by_id import (
    GetByIdOvertimeQuery,
    GetByIdOvertimeUseCase,
)
from src.application.use_cases.user.activate_user import (
    ActivateUserCommand,
    ActivateUserUseCase,
)
...
from src.application.use_cases.user.get_by_id import (
    GetUserByIdQuery,
    GetByIdUserUseCase,
)
from src.application.use_cases.user.update_role import (
    UpdateUserRoleCommand,
    UpdateUserRoleUseCase,
)
from src.application.use_cases.user.update_work_mode import (
...
class ApplicationProvider(Provider):
    ...
    update_user_work_mode_use_case = provide(
        UpdateUserWorkModeUseCase, scope=Scope.REQUEST
    )
    ...
    create_organization_use_case = provide(
        CreateOrganizationUseCase, scope=Scope.REQUEST
    )
    get_organization_use_case = provide(GetOrganizationUseCase, scope=Scope.REQUEST)
    get_all_organizations_use_case = provide(
        GetAllOrganizationUseCase, scope=Scope.REQUEST
    )
